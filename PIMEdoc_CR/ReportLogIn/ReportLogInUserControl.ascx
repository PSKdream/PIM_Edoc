...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportLogInUserControl.ascx.cs" Inherits="PIMEdoc_CR.ReportLogIn.ReportLogInUserControl" %>
                            ...
                            <asp:Panel runat="server" class="panel-body" DefaultButton="lkbtnSearchDepartment">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group stylish-input-group">
                                            <asp:TextBox runat="server" ID="txtSearch_Department" CssClass="form-control input-sm" placeholder="Search"></asp:TextBox>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                        ...
                                        <div class="row" runat="server" id="panel_searchEmp">
                                            ...
                                            <div class="col-xs-8 col-sm-9 col-md-10 col-lg-9">
                                                <div class="input-group stylish-input-group">
                                                    <asp:Label CssClass="form-control input-sm" runat="server" Enabled="false" ID="lbl_Employee"></asp:Label>
                                        ...
                                        <div runat="server" id="panel_searchDept" visible="false">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-sm-9 col-md-10 col-lg-9">
                                                    <div class="input-group stylish-input-group">
                                                        <asp:Label CssClass="form-control input-sm" runat="server" Enabled="false" ID="lbl_Department"></asp:Label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                                        <asp:Button Text="Submit" ID="btn_Submit" CssClass="CssButton" runat="server" OnClick="btn_Submit_Click" />
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                                        <asp:Button Text="Close" ID="btn_Close" CssClass="CssButton" runat="server" />
                                    </div>
                                    <div class="col-sm-2 col-md-2 col-lg-4"></div>
                                </div>
                            </div>
